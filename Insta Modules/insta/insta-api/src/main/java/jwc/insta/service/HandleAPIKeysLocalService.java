...
/**
 * Provides the local service interface for HandleAPIKeys. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see HandleAPIKeysLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface HandleAPIKeysLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HandleAPIKeysLocalServiceUtil} to access the handle api keys local service. Add custom service methods to <code>jwc.insta.service.impl.HandleAPIKeysLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
