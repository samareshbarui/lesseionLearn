...
/**
 * Provides the local service interface for InstaSiteImages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see InstaSiteImagesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface InstaSiteImagesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link InstaSiteImagesLocalServiceUtil} to access the insta site images local service. Add custom service methods to <code>jwc.insta.service.impl.InstaSiteImagesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public InstaSiteImages getRowByLinksAndTimestamp(
